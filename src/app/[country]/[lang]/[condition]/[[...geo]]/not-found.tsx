...
export default function ConditionGeoNotFound() {
    return (
        <div className="v4-root min-h-[60vh] bg-[--bg] text-[--ink-1] flex items-center justify-center px-6 py-16">
            <div className="card max-w-lg w-full p-8 text-center">
                ...
                <h1 className="display text-3xl mb-2">Page not found</h1>
                <p className="muted mb-6 text-sm">
                    We couldn&apos;t find that condition for the selected region or language.
                </p>
                <div className="flex items-center justify-center gap-3">
                    <Link href="/conditions" className="v4-btn v4-btn-cobalt">
                        Browse conditions
                    </Link>
