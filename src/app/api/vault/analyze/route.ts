 ...
 * Uses a free open-source reasoning model on OpenRouter.
 */
...
- If you can't analyze well, set confidence < 0.7`;
    ...
    const result = await aiChat(
        ...
        { mode: 'reasoning', temperature: 0.3, maxTokens: 1000 },
    );
    ...
    if (jsonMatch) {
        try {
            ...
            return {
                ...
                urgency: ['routine', 'urgent', 'emergency'].includes(parsed.urgency)
                    ? parsed.urgency
                    : 'routine',
