            ...
            contactPoint: [
                {
                    ...
                    email: 'support@aihealz.com',
                    availableLanguage: ['English', 'Hindi', 'Tamil', 'Telugu', 'Kannada', 'Marathi', 'Bengali', 'Gujarati', 'Malayalam', 'Punjabi', 'Arabic', 'Spanish', 'French', 'Portuguese', 'German'],
                    areaServed: ['IN', 'US', 'GB', 'AE', 'SG', 'AU', 'CA', 'MY', 'TH', 'PH', 'NG', 'KE', 'ZA', 'BR', 'MX', 'DE', 'FR', 'JP', 'KR', 'SA'],
                },
                {
                    '@type': 'ContactPoint',
                ...
                },
                {
                    '@type': 'ContactPoint',
                    contactType: 'sales',
                    email: 'partnerships@aihealz.com',
                    availableLanguage: ['English'],
                    areaServed: 'Worldwide',
                },
            ],
